...
public class ThirdPartyStepDefinitions {
    ...
    public void actor_clikea_el_boton_crear(Actor actor) {
        ...
        actor.attemptsTo(ShadowClick.using("return document.querySelector(\"siigo-header-molecule[class='data-siigo-five9 hydrated']\").shadowRoot.querySelector(\"siigo-button-atom[data-id='header-create-button']\").shadowRoot.querySelector(\"button\");"));
    }

    @And("{actor} clikea la opcion Clientes")
    public void actor_clikea_la_opcion_clientes(Actor actor) {
        actor.attemptsTo(ShadowClick.using("return document.querySelector(\"siigo-header-molecule[class='data-siigo-five9 hydrated']\").shadowRoot.querySelector(\"siigo-header-create-button-dropdown[data-id='header-create-button-dropdown']\").querySelector(\"div[class='content-create items-4 items-hidden']\").querySelector(\"div[class='content-create-items content-create-items-title-hidden content-create-items-open']\").querySelector(\"div[class='list list-customer-two']\").querySelector(\"li > div > a[data-value='Clientes']\");"));
    }
